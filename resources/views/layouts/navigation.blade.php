    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth                    
                    @can('create', App\Models\Vacante::class)
                        <a class="text-sm text-white font-extrabold mx-2 w-7 h-7 bg-indigo-600 hover:bg-indigo-800 rounded-full flex flex-col justify-center items-center" href="{{route('notificaciones')}}">
                ...
                @endauth
                @guest
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex sm:justify-between">
