<div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto">
            <h3 class="text-center md:text-left font-extrabold text-4xl text-gray-700 mb-12">Nuestras Vacantes Disponibles</h3>
                ...
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        ...
                        <div class="mt-5 md:mt-0">
                            <a href="{{route('vacantes.show', $vacante->id)}}" class="block text-center bg-indigo-500 p-3 text-sm uppercase font-bold text-white rounded-lg">Ver Vacante</a>
                        </div>
                    </div>
                @empty
