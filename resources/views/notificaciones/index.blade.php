        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                        ...
                        @forelse ($notificaciones as $notificacion)
                            <div class="p-5 lg:flex lg:justify-between lg:items-center">
                                <div>
                                    ...
                                    <p>
                                        <span class="font-bold">{{ str_replace("h", "H", $notificacion->created_at->diffForHumans()) }}</span>
                                    </p>
                                </div>
                    ...
                    <h1 class="text-2xl font-bold text-center mb-10 my-10">Notificaciones Leidas</h1>
                    ...
                    <div class="divide-y divide-gray-200">
                        @if (count($notificacionesLeidas) > 0)
                            ...
                            @endforeach
                        @else
                            <p class="text-center text-gray-600">No Hay Notificaciones Leidas</p> 
                        @endif
                    </div>
                </div>
            </div>
